...
impl FlightMode {
    const fn from_bit(bit: u32, firmware: crate::headers::FirmwareKind) -> Option<Self> {
        ...
        match (bit, firmware) {
            (0u32, Betaflight | EmuFlight) => Some(Self::Arm),
            (0u32, Inav) => Some(Self::Angle),
            (1u32, Betaflight | EmuFlight) => Some(Self::Angle),
            (1u32, Inav) => Some(Self::Horizon),
            (2u32, Betaflight | EmuFlight) => Some(Self::Horizon),
            (2u32, Inav) => Some(Self::Heading),
            (3u32, Betaflight | EmuFlight) => Some(Self::Mag),
            (3u32, Inav) => Some(Self::NavAltHold),
            (4u32, Betaflight | EmuFlight) => Some(Self::HeadFree),
            (4u32, Inav) => Some(Self::NavRth),
            (5u32, Betaflight | EmuFlight) => Some(Self::Passthru),
            (5u32, Inav) => Some(Self::NavPoshold),
            (6u32, Betaflight | EmuFlight) => Some(Self::Failsafe),
            (6u32, Inav) => Some(Self::HeadFree),
            (7u32, Betaflight | EmuFlight) => Some(Self::GpsRescue),
            (7u32, Inav) => Some(Self::NavLaunch),
            (8u32, Betaflight | EmuFlight) => Some(Self::Antigravity),
            (8u32, Inav) => Some(Self::Manual),
            (9u32, Betaflight | EmuFlight) => Some(Self::HeadAdjust),
            (9u32, Inav) => Some(Self::Failsafe),
            (10u32, Betaflight | EmuFlight) => Some(Self::CamStab),
            (10u32, Inav) => Some(Self::AutoTune),
            (11u32, Betaflight | EmuFlight) => Some(Self::BeeperOn),
            (11u32, Inav) => Some(Self::NavWp),
            (12u32, Betaflight | EmuFlight) => Some(Self::LedLow),
            (12u32, Inav) => Some(Self::NavCourseHold),
            (13u32, Betaflight | EmuFlight) => Some(Self::Calibrate),
            (13u32, Inav) => Some(Self::Flaperon),
            (14u32, Betaflight | EmuFlight) => Some(Self::Osd),
            (14u32, Inav) => Some(Self::TurnAssistant),
            (15u32, Betaflight | EmuFlight) => Some(Self::Telemetry),
            (15u32, Inav) => Some(Self::Turtle),
            (16u32, Betaflight | EmuFlight) => Some(Self::Servo1),
            (16u32, Inav) => Some(Self::Soaring),
            (17u32, Betaflight | EmuFlight) => Some(Self::Servo2),
            (18u32, Betaflight | EmuFlight) => Some(Self::Servo3),
            (19u32, Betaflight | EmuFlight) => Some(Self::Blackbox),
            (20u32, Betaflight | EmuFlight) => Some(Self::Airmode),
            (21u32, Betaflight | EmuFlight) => Some(Self::ThreeD),
            (22u32, Betaflight | EmuFlight) => Some(Self::FpvAngleMix),
            (23u32, Betaflight | EmuFlight) => Some(Self::BlackboxErase),
            (24u32, Betaflight | EmuFlight) => Some(Self::Camera1),
            (25u32, Betaflight | EmuFlight) => Some(Self::Camera2),
            (26u32, Betaflight | EmuFlight) => Some(Self::Camera3),
            (27u32, Betaflight | EmuFlight) => Some(Self::Turtle),
            (28u32, Betaflight | EmuFlight) => Some(Self::Prearm),
            (29u32, Betaflight | EmuFlight) => Some(Self::BeepGpsCount),
            (30u32, Betaflight | EmuFlight) => Some(Self::VtxPitmode),
            (31u32, Betaflight | EmuFlight) => Some(Self::Paralyze),
            _ => None,
        }
    }
    ...
    const fn to_bit(self, firmware: crate::headers::FirmwareKind) -> Option<u32> {
        use crate::headers::FirmwareKind::{Betaflight, EmuFlight, Inav};
        match (self, firmware) {
            (Self::Airmode, Betaflight | EmuFlight) => Some(20u32),
            (Self::Angle, Betaflight | EmuFlight) => Some(1u32),
            (Self::Angle, Inav) => Some(0u32),
            (Self::Antigravity, Betaflight | EmuFlight) => Some(8u32),
            (Self::Arm, Betaflight | EmuFlight) => Some(0u32),
            (Self::AutoTune, Inav) => Some(10u32),
            (Self::BeepGpsCount, Betaflight | EmuFlight) => Some(29u32),
            (Self::BeeperOn, Betaflight | EmuFlight) => Some(11u32),
            (Self::Blackbox, Betaflight | EmuFlight) => Some(19u32),
            (Self::BlackboxErase, Betaflight | EmuFlight) => Some(23u32),
            (Self::Calibrate, Betaflight | EmuFlight) => Some(13u32),
            (Self::CamStab, Betaflight | EmuFlight) => Some(10u32),
            (Self::Camera1, Betaflight | EmuFlight) => Some(24u32),
            (Self::Camera2, Betaflight | EmuFlight) => Some(25u32),
            (Self::Camera3, Betaflight | EmuFlight) => Some(26u32),
            (Self::Failsafe, Betaflight | EmuFlight) => Some(6u32),
            (Self::Failsafe, Inav) => Some(9u32),
            (Self::Flaperon, Inav) => Some(13u32),
            (Self::FpvAngleMix, Betaflight | EmuFlight) => Some(22u32),
            (Self::GpsRescue, Betaflight | EmuFlight) => Some(7u32),
            (Self::HeadAdjust, Betaflight | EmuFlight) => Some(9u32),
            (Self::HeadFree, Betaflight | EmuFlight) => Some(4u32),
            (Self::HeadFree, Inav) => Some(6u32),
            (Self::Heading, Inav) => Some(2u32),
            (Self::Horizon, Betaflight | EmuFlight) => Some(2u32),
            (Self::Horizon, Inav) => Some(1u32),
            (Self::LedLow, Betaflight | EmuFlight) => Some(12u32),
            (Self::Mag, Betaflight | EmuFlight) => Some(3u32),
            ...
            (Self::Osd, Betaflight | EmuFlight) => Some(14u32),
            (Self::Paralyze, Betaflight | EmuFlight) => Some(31u32),
            (Self::Passthru, Betaflight | EmuFlight) => Some(5u32),
            (Self::Prearm, Betaflight | EmuFlight) => Some(28u32),
            (Self::Servo1, Betaflight | EmuFlight) => Some(16u32),
            (Self::Servo2, Betaflight | EmuFlight) => Some(17u32),
            (Self::Servo3, Betaflight | EmuFlight) => Some(18u32),
            (Self::Soaring, Inav) => Some(16u32),
            (Self::Telemetry, Betaflight | EmuFlight) => Some(15u32),
            (Self::ThreeD, Betaflight | EmuFlight) => Some(21u32),
            (Self::TurnAssistant, Inav) => Some(14u32),
            (Self::Turtle, Betaflight | EmuFlight) => Some(27u32),
            (Self::Turtle, Inav) => Some(15u32),
            (Self::VtxPitmode, Betaflight | EmuFlight) => Some(30u32),
            _ => None,
        }
    }
}
