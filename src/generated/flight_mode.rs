...
impl FlightMode {
    const fn from_bit(bit: u32, fw: crate::headers::InternalFirmware) -> Option<Self> {
        ...
        match (bit, fw) {
            ...
            (9u32, Betaflight2025_12) => Some(Self::PosHold),
            ...
            (10u32, Betaflight2025_12) => Some(Self::GpsRescue),
    ...
    const fn to_bit(self, fw: crate::headers::InternalFirmware) -> Option<u32> {
        ...
        match (self, fw) {
            ...
            (Self::GpsRescue, Betaflight2025_12) => Some(10u32),
